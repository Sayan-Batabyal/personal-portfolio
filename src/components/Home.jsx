       ...
       <AnimatedText text="H e l l o, &nbsp; I &nbsp; a m" className='text-left !text-4xl !text-sky-500 xl:!text-6xl lg:!text-center lg:!text-5xl md:!text-5xl sm:!text-4xl ' />
        <div className="flex items-center justify-between w-full">
          <div className=''>
            ...
            <p className='my-4 md:text-sm sm:text-xs text-base font-medium font-mono text-justify'>I'm a third-year software development student with a passion for creating elegant solutions that solve real-world problems. My expertise lies in, and I'm constantly seeking opportunities to develop my skills in [list relevant skills or methodologies]. I have experience working on [list types of projects or applications], and I'm committed to staying up-to-date with the latest industry trends. Feel free to check out my portfolio or connect with me to learn more about my work.</p>
          </div>
        </div>
